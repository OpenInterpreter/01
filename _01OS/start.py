...
import os
import importlib
create_tunnel = importlib.import_module(".server.tunnel", package="_01OS").create_tunnel
import signal
app = typer.Typer()
...
def _run(
    ...
    if server:
        main = importlib.import_module(".server.server", package="_01OS").main
    ...
    if client:
        ...
        module = importlib.import_module(f".clients.{client_type}.device", package='_01OS')
